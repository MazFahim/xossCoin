...
class Blockchain {
    ...
    generateGenesisBlock(){
        return new Block("31-01-2022", "GENESIS", "0000")
    }
...
xosscoin.addTransaction(new Transaction("address1", "address2", 100));
xosscoin.addTransaction(new Transaction("address2", "address1", 50));

xosscoin.minePendingTransactions('mariyam-plaza');
console.log(xosscoin.getBalanceOfAddress("mariyam-plaza"));
